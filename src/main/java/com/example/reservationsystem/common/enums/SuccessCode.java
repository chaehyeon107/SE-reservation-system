...
public enum SuccessCode implements BaseCode {
    ...
    CREATE_SEAT_SUCCESS(HttpStatus.CREATED, "좌석 예약이 생성되었습니다."),
    ...
    CREATE_RESERVATION_SUCCESS(HttpStatus.CREATED,"회의실 예약이 생성되었습니다."),

    GET_SEAT_AVAILABILITY_SUCCESS(HttpStatus.OK,"예약된 좌석 조회 성공"),
    GET_SEAT_RESERVATIONS_SUCCESS(HttpStatus.OK,"내 좌석 예약 조회 성공"),
    CREATE_SEAT_RESERVATION_SUCCESS(HttpStatus.OK,"좌석 예약 완료"),
    CREATE_RANDOM_SEAT_RESERVATION_SUCCESS(HttpStatus.OK,"랜덤 좌석 예약 완료");
